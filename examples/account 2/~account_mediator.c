...
/**  Date: Fri Jul 14 02:24:15 PDT 2023                                      **/
/**                                                                          **/
/******************************************************************************/
...
void sequential_deposit_media( CallProperties* __properties, AccountModel *acct, int sum )
{
        ...
        _dummy( &__up ); _dummy( &__cmd );
        {
            ...
            if(__properties->verdict )
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ptr_to__AccountModel
                                            , &acct
                                            );
                tracePrimeFormula( 1, __properties->verdict );
                if( !__properties->verdict ) setBadVerdict( "Invariant of acct failed" );
            }
...
void call_deposit_media( CallProperties* __properties, AccountModel *acct, int sum )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
...
void parallel_deposit_media( CallProperties* __properties, AccountModel *acct, int sum )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_deposit_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
        {
            assertion( (acct == (void*)0) == (__context_deposit_spec.params->outpar1 == (void*)0), 
                       "Inconsistent parameter value: acct"
                     );
            if (acct != (void*)0)
              ts_copy_sectype( (SECTypeDesc*)&__type_desc__AccountModel, acct, __context_deposit_spec.params->outpar1, 1 );
            if(__properties->verdict )
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ptr_to__AccountModel
...
MEDIATOR_deposit_spec deposit_media = 
{
  sequential_deposit_media,
  call_deposit_media,
  parallel_deposit_media
};

int sequential_withdraw_media( CallProperties* __properties, AccountModel *acct, int sum )
{
    int __res;
    bool __alias1_has_value = 
             1;
...
int call_withdraw_media( CallProperties* __properties, AccountModel *acct, int sum )
{
    int __res;
    bool __alias1_has_value = 
             1;
...
int parallel_withdraw_media( CallProperties* __properties, AccountModel *acct, int sum )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_withdraw_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
        {
            assertion( (acct == (void*)0) == (__context_withdraw_spec.params->outpar1 == (void*)0), 
                       "Inconsistent parameter value: acct"
                     );
            if (acct != (void*)0)
              ts_copy_sectype( (SECTypeDesc*)&__type_desc__AccountModel, acct, __context_withdraw_spec.params->outpar1, 1 );
            if(__properties->verdict )
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ptr_to__AccountModel
    ...
    return __context_withdraw_spec.params->res;
}

MEDIATOR_withdraw_spec withdraw_media = 
{
  sequential_withdraw_media,
  call_withdraw_media,
  parallel_withdraw_media
};
