...
/**  Date: Fri Jul 14 02:24:16 PDT 2023                                      **/
/**                                                                          **/
/******************************************************************************/
...
extern MEDIATOR_deposit_spec deposit_media;

extern MEDIATOR_withdraw_spec withdraw_media;
...

{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        { __res = (create_Integer(acct.balance)); goto __destroy_body; }
...
__destroy_body:;
    ts_check_spec_ref( &type_Integer
                     , __res
                     , "returned value of account_state"
                     , (void*)0
                     );
    return __res;
}
...
static void init___deposit_scen_Par( struct __deposit_scen_Par *_tmp_par, va_list *arg_list )
{
    memset( _tmp_par, 0, sizeof( *_tmp_par ) );
}

typedef struct __deposit_scen_Par __deposit_scen_Par;
static StructTypeDesc __type_desc__struct___deposit_scen_Par;

static int compare___deposit_scen_Par( struct __deposit_scen_Par *left, struct __deposit_scen_Par *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct___deposit_scen_Par, left, right ) )
      return 0;
    return 1;
}

static String* to_string___deposit_scen_Par( struct __deposit_scen_Par *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct___deposit_scen_Par, obj );
}

static String* to_XML___deposit_scen_Par( struct __deposit_scen_Par *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct___deposit_scen_Par, obj );
}

const Type type___deposit_scen_Par =
{
  "__deposit_scen_Par",
  sizeof(struct __deposit_scen_Par),
  &type_Object,
  (Init)init___deposit_scen_Par,
  (Copy)copy_Default,
  (Compare)compare___deposit_scen_Par,
  (ToString)to_string___deposit_scen_Par,
  (ToXML)to_XML___deposit_scen_Par,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_Default
};

Object *__deposit_scen_init( void )
{
    __deposit_scen_Par *_tmp_par = (__deposit_scen_Par *)create( &type___deposit_scen_Par );
    _tmp_par->index = -1;
    _tmp_par->flags = 0;
    return (Object *)_tmp_par;
}

bool __deposit_scen_hasNext( Object *__par )
{
    __deposit_scen_Par *_tmp_par = (__deposit_scen_Par *)__par;
    bool has_next = 0;
...
bool __deposit_scen_call( Object *__par )
{
    __deposit_scen_Par *_tmp_par = (__deposit_scen_Par *)__par;
                ...
                // start of iteration statement
                {
                    ...
                    if( !(_tmp_par->flags & 1) )
                    {
                        ...
                        if( !_tmp_par->i_0_init )
                        {
                            ...
                            if( !(_tmp_par->i_0 <= 5) ) goto __end_iteration_0;
                            _tmp_par->i_0_init = 1;
                        }
                        ...
                        {
                            _tmp_par->i_0++;
                            if (!(_tmp_par->i_0 <= 5)) goto __end_iterating_0;
                        }
                    }
                    if( !(_tmp_par->flags & 2) )
                    {
                    ...
                    call_active_oracle_deposit_spec(&acct
                    , _tmp_par->i_0);
...
bool __deposit_scen_next( Object *__par )
{
    __deposit_scen_Par *_tmp_par = (__deposit_scen_Par *)__par;
    _tmp_par->flags |= 2;
    __deposit_scen_call( r(_tmp_par) );
    _tmp_par->flags &= ~2;
    return __deposit_scen_hasNext( _tmp_par );
}

ScenarioFunctionDesc deposit_scen =
{
    &__deposit_scen_init,
    &__deposit_scen_hasNext,
    &__deposit_scen_next,
    &__deposit_scen_call,
    "deposit_scen"
};

struct __withdraw_scen_Par
{
    int index;
    int flags;
    int i_0;
...
static void init___withdraw_scen_Par( struct __withdraw_scen_Par *_tmp_par, va_list *arg_list )
{
    memset( _tmp_par, 0, sizeof( *_tmp_par ) );
}

typedef struct __withdraw_scen_Par __withdraw_scen_Par;
static StructTypeDesc __type_desc__struct___withdraw_scen_Par;

static int compare___withdraw_scen_Par( struct __withdraw_scen_Par *left, struct __withdraw_scen_Par *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct___withdraw_scen_Par, left, right ) )
      return 0;
    return 1;
}

static String* to_string___withdraw_scen_Par( struct __withdraw_scen_Par *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct___withdraw_scen_Par, obj );
}

static String* to_XML___withdraw_scen_Par( struct __withdraw_scen_Par *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct___withdraw_scen_Par, obj );
}

const Type type___withdraw_scen_Par =
{
  "__withdraw_scen_Par",
  sizeof(struct __withdraw_scen_Par),
  &type_Object,
  (Init)init___withdraw_scen_Par,
  (Copy)copy_Default,
  (Compare)compare___withdraw_scen_Par,
  (ToString)to_string___withdraw_scen_Par,
  (ToXML)to_XML___withdraw_scen_Par,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_Default
};

Object *__withdraw_scen_init( void )
{
    __withdraw_scen_Par *_tmp_par = (__withdraw_scen_Par *)create( &type___withdraw_scen_Par );
    _tmp_par->index = -1;
    _tmp_par->flags = 0;
    return (Object *)_tmp_par;
}

bool __withdraw_scen_hasNext( Object *__par )
{
    __withdraw_scen_Par *_tmp_par = (__withdraw_scen_Par *)__par;
    bool has_next = 0;
...
bool __withdraw_scen_call( Object *__par )
{
    __withdraw_scen_Par *_tmp_par = (__withdraw_scen_Par *)__par;
    ...
    clearOracleVerdict();
    {
...

        {
            // start of iteration statement
            {
                ...
                call_active_oracle_withdraw_spec(&acct
                , _tmp_par->i_0);
...
bool __withdraw_scen_next( Object *__par )
{
    __withdraw_scen_Par *_tmp_par = (__withdraw_scen_Par *)__par;
    _tmp_par->flags |= 2;
    __withdraw_scen_call( r(_tmp_par) );
    _tmp_par->flags &= ~2;
    return __withdraw_scen_hasNext( _tmp_par );
}

ScenarioFunctionDesc withdraw_scen =
{
    &__withdraw_scen_init,
    &__withdraw_scen_hasNext,
    &__withdraw_scen_next,
    &__withdraw_scen_call,
    "withdraw_scen"
};
...
bool start_account_scenario( int argc, char** argv )
{
    return start_dfsm( argc, argv, &account_scenario );
}
...
static FieldDesc __fields_desc__struct___deposit_scen_Par[] = 
{
    { "index", ((char*)(&((struct __deposit_scen_Par*)0)->index) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "flags", ((char*)(&((struct __deposit_scen_Par*)0)->flags) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0", ((char*)(&((struct __deposit_scen_Par*)0)->i_0) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_init", ((char*)(&((struct __deposit_scen_Par*)0)->i_0_init) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_used", ((char*)(&((struct __deposit_scen_Par*)0)->i_0_used) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
, sizeof( struct __deposit_scen_Par )
, 5
, __fields_desc__struct___deposit_scen_Par
};
...
static FieldDesc __fields_desc__struct___withdraw_scen_Par[] = 
{
    { "index", ((char*)(&((struct __withdraw_scen_Par*)0)->index) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "flags", ((char*)(&((struct __withdraw_scen_Par*)0)->flags) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0", ((char*)(&((struct __withdraw_scen_Par*)0)->i_0) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_init", ((char*)(&((struct __withdraw_scen_Par*)0)->i_0_init) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_used", ((char*)(&((struct __withdraw_scen_Par*)0)->i_0_used) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
, sizeof( struct __withdraw_scen_Par )
, 5
, __fields_desc__struct___withdraw_scen_Par
};
