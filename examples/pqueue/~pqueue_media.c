...
/**  Date: Sat Oct 07 00:52:11 PDT 2023                                      **/
/**                                                                          **/
/******************************************************************************/
...
void sequential_enq_media( CallProperties* __properties, Item item )
{
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
        {
            __properties->time = overallTimeInterval;
            setAutomaticTimeMark(&__properties->time.minMark);
            {
                enq(item);


            }
            setAutomaticTimeMark(&__properties->time.maxMark);
            __properties->verdict = !isBadVerdict();

            if (__properties->verdict)
            {
                {
                    append_List(r(low)
                    , create_VoidAst(item));
            ...
            if (__properties->verdict && __alias3_has_value && 1)
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ref_Queue
                                            , &low
                                            );
                tracePrimeFormula( 5, __properties->verdict );
                  if (!__properties->verdict) setBadVerdict( "Invariant of low failed" );
            }
...
void call_enq_media( CallProperties* __properties, Item item )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
...
void parallel_enq_media( CallProperties* __properties, Item item )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_enq_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
...
MEDIATOR_enq_spec enq_media = 
{
  sequential_enq_media,
  call_enq_media,
  parallel_enq_media
};

void sequential_enqp_media( CallProperties* __properties, Item item )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    clearBadVerdict();
    {
        ...
        _dummy( &__up ); _dummy( &__cmd );
        {
            ...
            if (__properties->verdict && __alias2_has_value && 1)
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ref_Queue
                                            , &high
                                            );
                tracePrimeFormula( 3, __properties->verdict );
                  if (!__properties->verdict) setBadVerdict( "Invariant of high failed" );
            }
...
void call_enqp_media( CallProperties* __properties, Item item )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
...
void parallel_enqp_media( CallProperties* __properties, Item item )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_enqp_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
...
MEDIATOR_enqp_spec enqp_media = 
{
  sequential_enqp_media,
  call_enqp_media,
  parallel_enqp_media
};
...
void *sequential_deq_media( CallProperties* __properties )
{
    void *__res;
    bool __alias1_has_value = 
             1;
    ...
    clearBadVerdict();
    {
        ...
        __after_call:
            ...
            if (__properties->verdict && __alias1_has_value && 1)
            {
                __properties->verdict = ts_check_invariant_sectype
                                            ( (SECTypeDesc*)&__type_desc__ref_Queue
                                            , &high
                                            );
                tracePrimeFormula( 1, __properties->verdict );
                  if (!__properties->verdict) setBadVerdict( "Invariant of high failed" );
            }
            if (__properties->verdict && __alias2_has_value && 1)
            {
...
void *call_deq_media( CallProperties* __properties )
{
    void *__res;
    bool __alias1_has_value = 
             1;
...
void *parallel_deq_media( CallProperties* __properties )
{
    bool __alias1_has_value = 
             1;
    bool __alias2_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_deq_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
    ...
    return __context_deq_spec.params->res;
}

MEDIATOR_deq_spec deq_media = 
{
  sequential_deq_media,
  call_deq_media,
  parallel_deq_media
};
