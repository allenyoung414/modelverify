...
/**  Date: Sat Oct 07 00:52:12 PDT 2023                                      **/
/**                                                                          **/
/******************************************************************************/
...
bool start_pqueue_scenario(int argc,char** argv);
...
extern MEDIATOR_enq_spec enq_media;

extern MEDIATOR_enqp_spec enqp_media;

extern MEDIATOR_deq_spec deq_media;
...

{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        ...
        if( queue_size <= 0 )
        {
            printf("Error: queue_size (%d) should be positive"
            , queue_size);
        ...
        if( items_num <= 0 )
        {
            printf("Error: items_num (%d) should be positive"
            , items_num);
        ...
        ts_assign_spec_ref(
            (Object**)&(low),
            ((Queue *)ts_cast_spec_ref( &type_Queue, create_List(&type_VoidAst) )),
            "pqueue_scenario.sec(74,7)"
                          );

        ts_assign_spec_ref(
            (Object**)&(high),
            ((Queue *)ts_cast_spec_ref( &type_Queue, create_List(&type_VoidAst) )),
            "pqueue_scenario.sec(75,8)"
                          );
...

{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        ...
        ts_assign_spec_ref(
            (Object**)&(high),
            ts_check_spec_ref( &type_Queue, (((void *)0)), "assignment to high", "pqueue_scenario.sec(90,8)" ),
            "pqueue_scenario.sec(90,8)"
                          );

        ts_assign_spec_ref(
            (Object**)&(low),
            ts_check_spec_ref( &type_Queue, (((void *)0)), "assignment to low", "pqueue_scenario.sec(91,7)" ),
            "pqueue_scenario.sec(91,7)"
                          );
...
static StructTypeDesc __type_desc__IntPair;

static void init_IntPair( IntPair *obj, va_list* arg_list )
{
    obj->h = va_arg( *arg_list, int );
    obj->l = va_arg( *arg_list, int );
}

static int compare_IntPair( IntPair *left, IntPair *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__IntPair, left, right ) )
      return 0;
    return 1;
}

static String* to_string_IntPair( IntPair *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__IntPair, obj );
}

static String* to_XML_IntPair( IntPair *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__IntPair, obj );
}

const Type type_IntPair =
{
  "IntPair",
  sizeof(IntPair),
  &type_Object,
  (Init)init_IntPair,
  (Copy)copy_Default,
  (Compare)compare_IntPair,
  (ToString)to_string_IntPair,
  (ToXML)to_XML_IntPair,
...
{
    IntPair *__res = (void*)0;
    int __up = 0, __cmd = -3;
    _dummy( &__up ); _dummy( &__cmd );
    {
        { __res = (create(&type_IntPair
        , h
        , l)); goto __destroy_body; }
...
goto __destroy_body;
__destroy_body:;
    ts_check_spec_ref( &type_IntPair
                     , __res
                     , "returned value of create_IntPair"
                     , (void*)0
                     );
    return __res;
}
...

{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        { __res = (create_IntPair(size_List(r(high))
        , size_List(r(low)))); goto __destroy_body; }
...
static void init___enq_scen_Par( struct __enq_scen_Par *_tmp_par, va_list *arg_list )
{
    memset( _tmp_par, 0, sizeof( *_tmp_par ) );
}

typedef struct __enq_scen_Par __enq_scen_Par;
static StructTypeDesc __type_desc__struct___enq_scen_Par;

static int compare___enq_scen_Par( struct __enq_scen_Par *left, struct __enq_scen_Par *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct___enq_scen_Par, left, right ) )
      return 0;
    return 1;
}

static String* to_string___enq_scen_Par( struct __enq_scen_Par *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct___enq_scen_Par, obj );
}

static String* to_XML___enq_scen_Par( struct __enq_scen_Par *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct___enq_scen_Par, obj );
}

const Type type___enq_scen_Par =
{
  "__enq_scen_Par",
  sizeof(struct __enq_scen_Par),
  &type_Object,
  (Init)init___enq_scen_Par,
  (Copy)copy_Default,
  (Compare)compare___enq_scen_Par,
  (ToString)to_string___enq_scen_Par,
  (ToXML)to_XML___enq_scen_Par,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_Default
};

Object *__enq_scen_init( void )
{
    __enq_scen_Par *_tmp_par = (__enq_scen_Par *)create( &type___enq_scen_Par );
    _tmp_par->index = -1;
    _tmp_par->flags = 0;
    return (Object *)_tmp_par;
}

bool __enq_scen_hasNext( Object *__par )
{
    __enq_scen_Par *_tmp_par = (__enq_scen_Par *)__par;
    bool has_next = 0;
...
bool __enq_scen_call( Object *__par )
{
    __enq_scen_Par *_tmp_par = (__enq_scen_Par *)__par;
            ...
            // start of iteration statement
            {
                ...
                if( !(_tmp_par->flags & 1) )
                {
                    ...
                    if( !_tmp_par->i_0_init )
                    {
                        ...
                        while( ( __tmp = (_tmp_par->i_0 < queue_size) ) && !( size_List(r(low)) < queue_size ) )
                          _tmp_par->i_0++;
                        if( !__tmp ) goto __end_iteration_0;
                        _tmp_par->i_0_init = 1;
                    }
                    ...
                    else
                    {
                        do
                          _tmp_par->i_0++;
                        while( ( __tmp = (_tmp_par->i_0 < queue_size) ) && !(size_List(r(low)) < queue_size) );
                        if( !__tmp ) goto __end_iterating_0;
                    }
                }
                if( !(_tmp_par->flags & 2) )
                {
                ...
                call_active_oracle_enq_spec(create_Integer(_tmp_par->i_0));
...
bool __enq_scen_next( Object *__par )
{
    __enq_scen_Par *_tmp_par = (__enq_scen_Par *)__par;
    _tmp_par->flags |= 2;
    __enq_scen_call( r(_tmp_par) );
    _tmp_par->flags &= ~2;
    return __enq_scen_hasNext( _tmp_par );
}

ScenarioFunctionDesc enq_scen =
{
    &__enq_scen_init,
    &__enq_scen_hasNext,
    &__enq_scen_next,
...
static void init___enqp_scen_Par( struct __enqp_scen_Par *_tmp_par, va_list *arg_list )
{
    memset( _tmp_par, 0, sizeof( *_tmp_par ) );
}

typedef struct __enqp_scen_Par __enqp_scen_Par;
static StructTypeDesc __type_desc__struct___enqp_scen_Par;

static int compare___enqp_scen_Par( struct __enqp_scen_Par *left, struct __enqp_scen_Par *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct___enqp_scen_Par, left, right ) )
      return 0;
    return 1;
}

static String* to_string___enqp_scen_Par( struct __enqp_scen_Par *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct___enqp_scen_Par, obj );
}

static String* to_XML___enqp_scen_Par( struct __enqp_scen_Par *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct___enqp_scen_Par, obj );
}

const Type type___enqp_scen_Par =
{
  "__enqp_scen_Par",
  sizeof(struct __enqp_scen_Par),
  &type_Object,
  (Init)init___enqp_scen_Par,
  (Copy)copy_Default,
  (Compare)compare___enqp_scen_Par,
  (ToString)to_string___enqp_scen_Par,
  (ToXML)to_XML___enqp_scen_Par,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_Default
};

Object *__enqp_scen_init( void )
{
    __enqp_scen_Par *_tmp_par = (__enqp_scen_Par *)create( &type___enqp_scen_Par );
    _tmp_par->index = -1;
    _tmp_par->flags = 0;
    return (Object *)_tmp_par;
}

bool __enqp_scen_hasNext( Object *__par )
{
    __enqp_scen_Par *_tmp_par = (__enqp_scen_Par *)__par;
    bool has_next = 0;
...
bool __enqp_scen_call( Object *__par )
{
    __enqp_scen_Par *_tmp_par = (__enqp_scen_Par *)__par;
            ...
            // start of iteration statement
            {
                ...
                if( !(_tmp_par->flags & 1) )
                {
                    ...
                    if( !_tmp_par->i_0_init )
                    {
                        ...
                        while( ( __tmp = (_tmp_par->i_0 < queue_size) ) && !( size_List(r(high)) < queue_size ) )
                          _tmp_par->i_0++;
                        if( !__tmp ) goto __end_iteration_0;
                        _tmp_par->i_0_init = 1;
                    }
                ...
                call_active_oracle_enqp_spec(create_Integer(_tmp_par->i_0));
...
bool __enqp_scen_next( Object *__par )
{
    __enqp_scen_Par *_tmp_par = (__enqp_scen_Par *)__par;
    _tmp_par->flags |= 2;
    __enqp_scen_call( r(_tmp_par) );
    _tmp_par->flags &= ~2;
    return __enqp_scen_hasNext( _tmp_par );
}

ScenarioFunctionDesc enqp_scen =
{
    &__enqp_scen_init,
    &__enqp_scen_hasNext,
    &__enqp_scen_next,
...
struct __deq_scen_Par
{
    int index;
    int flags;
};

static void init___deq_scen_Par( struct __deq_scen_Par *_tmp_par, va_list *arg_list )
{
    memset( _tmp_par, 0, sizeof( *_tmp_par ) );
}

typedef struct __deq_scen_Par __deq_scen_Par;
static StructTypeDesc __type_desc__struct___deq_scen_Par;

static int compare___deq_scen_Par( struct __deq_scen_Par *left, struct __deq_scen_Par *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct___deq_scen_Par, left, right ) )
      return 0;
    return 1;
}

static String* to_string___deq_scen_Par( struct __deq_scen_Par *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct___deq_scen_Par, obj );
}

static String* to_XML___deq_scen_Par( struct __deq_scen_Par *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct___deq_scen_Par, obj );
}

const Type type___deq_scen_Par =
{
  "__deq_scen_Par",
  sizeof(struct __deq_scen_Par),
  &type_Object,
  (Init)init___deq_scen_Par,
  (Copy)copy_Default,
  (Compare)compare___deq_scen_Par,
  (ToString)to_string___deq_scen_Par,
  (ToXML)to_XML___deq_scen_Par,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_Default
};

Object *__deq_scen_init( void )
{
    __deq_scen_Par *_tmp_par = (__deq_scen_Par *)create( &type___deq_scen_Par );
    _tmp_par->index = -1;
    _tmp_par->flags = 0;
    return (Object *)_tmp_par;
}

bool __deq_scen_hasNext( Object *__par )
{
    __deq_scen_Par *_tmp_par = (__deq_scen_Par *)__par;
    bool has_next = 0;
...
bool __deq_scen_call( Object *__par )
{
    __deq_scen_Par *_tmp_par = (__deq_scen_Par *)__par;
...
bool __deq_scen_next( Object *__par )
{
    __deq_scen_Par *_tmp_par = (__deq_scen_Par *)__par;
...
dfsm pqueue_scenario = {
      "pqueue_scenario"
    , (PtrInit)initPQueue
    , (PtrGetState)statePQueue
    , (void*)0
    , (void*)0
    , (void*)0
    , (void*)0
    , (void*)0
    , (PtrFinish)finishPQueue
...
bool start_pqueue_scenario( int argc, char** argv )
{
    return start_dfsm( argc, argv, &pqueue_scenario );
}
...
static FieldDesc __fields_desc__IntPair[] = 
{
    { "h", ((char*)(&((IntPair*)0)->h) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "l", ((char*)(&((IntPair*)0)->l) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
static FieldDesc __fields_desc__struct___enq_scen_Par[] = 
{
    { "index", ((char*)(&((struct __enq_scen_Par*)0)->index) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "flags", ((char*)(&((struct __enq_scen_Par*)0)->flags) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0", ((char*)(&((struct __enq_scen_Par*)0)->i_0) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_init", ((char*)(&((struct __enq_scen_Par*)0)->i_0_init) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_used", ((char*)(&((struct __enq_scen_Par*)0)->i_0_used) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
, sizeof( struct __enq_scen_Par )
, 5
, __fields_desc__struct___enq_scen_Par
};
...
static FieldDesc __fields_desc__struct___enqp_scen_Par[] = 
{
    { "index", ((char*)(&((struct __enqp_scen_Par*)0)->index) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "flags", ((char*)(&((struct __enqp_scen_Par*)0)->flags) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0", ((char*)(&((struct __enqp_scen_Par*)0)->i_0) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_init", ((char*)(&((struct __enqp_scen_Par*)0)->i_0_init) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "i_0_used", ((char*)(&((struct __enqp_scen_Par*)0)->i_0_used) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
, sizeof( struct __enqp_scen_Par )
, 5
, __fields_desc__struct___enqp_scen_Par
};
...
static FieldDesc __fields_desc__struct___deq_scen_Par[] = 
{
    { "index", ((char*)(&((struct __deq_scen_Par*)0)->index) - (char*)0), (SECTypeDesc*)&__type_desc__int },
    { "flags", ((char*)(&((struct __deq_scen_Par*)0)->flags) - (char*)0), (SECTypeDesc*)&__type_desc__int }
};
...
, sizeof( struct __deq_scen_Par )
, 2
, __fields_desc__struct___deq_scen_Par
};
