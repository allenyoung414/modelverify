...
/**  Date: Sat Oct 07 00:52:10 PDT 2023                                      **/
/**                                                                          **/
/******************************************************************************/
...
Type* elemType_List(List * self);
 typedef void* Item;
bool invariant_type_Item( Item* );
 typedef List Queue;
bool invariant_type_Queue( Queue* );
extern const Type type_Queue;
extern Queue* low;
extern Queue* high;
#ifndef PAR_RES_TYPE_enq_spec_DEFINED
#define PAR_RES_TYPE_enq_spec_DEFINED

struct PAR_RES_TYPE_enq_spec
{
Item inpar1;
Item outpar1;
};

typedef struct PAR_RES_TYPE_enq_spec PAR_RES_TYPE_enq_spec;
extern const Type type_PAR_RES_TYPE_enq_spec;

#endif

#ifndef CONTEXT_TYPE_enq_spec_DEFINED
#define CONTEXT_TYPE_enq_spec_DEFINED

typedef
struct CONTEXT_TYPE_enq_spec
{
  PAR_RES_TYPE_enq_spec* params;
  TimeInterval  time;
  InteractionId refId;
} CONTEXT_TYPE_enq_spec;

#endif

extern CONTEXT_TYPE_enq_spec __context_enq_spec;

#ifndef MEDIATOR_enq_spec_DEFINED
#define MEDIATOR_enq_spec_DEFINED
  typedef void (*MEDIATOR_FUNC_enq_spec)( CallProperties*, Item item );
  typedef struct MEDIATOR_enq_spec
   {
    MEDIATOR_FUNC_enq_spec sequential_mediator;
    MEDIATOR_FUNC_enq_spec call_mediator;
    MEDIATOR_FUNC_enq_spec parallel_mediator;
   } 
  MEDIATOR_enq_spec;
#endif

MEDIATOR_enq_spec set_mediator_enq_spec( MEDIATOR_enq_spec m );

bool pre_enq_spec( Item item );

void oracle_enq_spec( MEDIATOR_FUNC_enq_spec __media, OracleCallProperties* __oracle_properties, Item item );

OracleVerdict call_pure_oracle_enq_spec( CONTEXT_TYPE_enq_spec context );

void call_active_oracle_enq_spec( Item item );

extern SpecificationID enq_spec;

#ifndef PAR_RES_TYPE_enqp_spec_DEFINED
#define PAR_RES_TYPE_enqp_spec_DEFINED

struct PAR_RES_TYPE_enqp_spec
{
Item inpar1;
Item outpar1;
};

typedef struct PAR_RES_TYPE_enqp_spec PAR_RES_TYPE_enqp_spec;
extern const Type type_PAR_RES_TYPE_enqp_spec;

#endif

#ifndef CONTEXT_TYPE_enqp_spec_DEFINED
#define CONTEXT_TYPE_enqp_spec_DEFINED

typedef
struct CONTEXT_TYPE_enqp_spec
{
  PAR_RES_TYPE_enqp_spec* params;
  TimeInterval  time;
  InteractionId refId;
} CONTEXT_TYPE_enqp_spec;

#endif

extern CONTEXT_TYPE_enqp_spec __context_enqp_spec;

#ifndef MEDIATOR_enqp_spec_DEFINED
#define MEDIATOR_enqp_spec_DEFINED
  typedef void (*MEDIATOR_FUNC_enqp_spec)( CallProperties*, Item item );
  typedef struct MEDIATOR_enqp_spec
   {
    MEDIATOR_FUNC_enqp_spec sequential_mediator;
    MEDIATOR_FUNC_enqp_spec call_mediator;
    MEDIATOR_FUNC_enqp_spec parallel_mediator;
   } 
  MEDIATOR_enqp_spec;
#endif

MEDIATOR_enqp_spec set_mediator_enqp_spec( MEDIATOR_enqp_spec m );

bool pre_enqp_spec( Item item );

void oracle_enqp_spec( MEDIATOR_FUNC_enqp_spec __media, OracleCallProperties* __oracle_properties, Item item );

OracleVerdict call_pure_oracle_enqp_spec( CONTEXT_TYPE_enqp_spec context );

void call_active_oracle_enqp_spec( Item item );

extern SpecificationID enqp_spec;

#ifndef PAR_RES_TYPE_deq_spec_DEFINED
#define PAR_RES_TYPE_deq_spec_DEFINED

struct PAR_RES_TYPE_deq_spec
{
void *res;
};

typedef struct PAR_RES_TYPE_deq_spec PAR_RES_TYPE_deq_spec;
extern const Type type_PAR_RES_TYPE_deq_spec;

#endif

#ifndef CONTEXT_TYPE_deq_spec_DEFINED
#define CONTEXT_TYPE_deq_spec_DEFINED

typedef
struct CONTEXT_TYPE_deq_spec
{
  PAR_RES_TYPE_deq_spec* params;
  TimeInterval  time;
  InteractionId refId;
} CONTEXT_TYPE_deq_spec;

#endif

extern CONTEXT_TYPE_deq_spec __context_deq_spec;

#ifndef MEDIATOR_deq_spec_DEFINED
#define MEDIATOR_deq_spec_DEFINED
  typedef void *(*MEDIATOR_FUNC_deq_spec)( CallProperties* );
  typedef struct MEDIATOR_deq_spec
   {
    MEDIATOR_FUNC_deq_spec sequential_mediator;
    MEDIATOR_FUNC_deq_spec call_mediator;
    MEDIATOR_FUNC_deq_spec parallel_mediator;
   } 
  MEDIATOR_deq_spec;
#endif

MEDIATOR_deq_spec set_mediator_deq_spec( MEDIATOR_deq_spec m );

bool pre_deq_spec( void );

void *oracle_deq_spec( MEDIATOR_FUNC_deq_spec __media, OracleCallProperties* __oracle_properties );

OracleVerdict call_pure_oracle_deq_spec( CONTEXT_TYPE_deq_spec context );

void *call_active_oracle_deq_spec( void );

extern SpecificationID deq_spec;

Queue* low;
Queue* high;
bool invariant_type_Item(Item* item)
{
    {
        bool __res = 0;
        int __up = 0, __cmd = -3;
        ...
        {
            { __res = ((*item) != ((void *)0)); goto __destroy_body; }
...
bool invariant_type_Queue(Queue* queue)
{
    if (!type_List.check_invariant(r(queue)))
    {
        destroy(queue);
        return 0;
    }
    {
        ...
        _dummy( &__up ); _dummy( &__cmd );
        {
            ...
            {
                if( value_VoidAst(ts_check_spec_ref( &type_VoidAst, get_List(r(queue)
                , i), "1 argument of value_VoidAst", "pqueue_model.sec(44,22)" )) == ((void *)0) )
                {
...
const Type type_Queue =
{
  ...
  (Init)init_Subtype,
  (Copy)copy_Subtype,
  (Compare)compare_Subtype,
  (ToString)to_string_Subtype,
  (ToXML)to_XML_Subtype,
  (CheckInvariant)invariant_type_Queue,
  (Enumerate)enumerate_Subtype,
  (Destroy)destroy_Subtype
};

CoverageElement _cov_calc_PriorityListsCoverage( void );

CoverageDesc _cov_desc_PriorityListsCoverage =
{ PRIMARY_COVERAGE
, 4
, 0
, 1
, 1
, -1
, "PriorityListsCoverage"
, &_cov_calc_PriorityListsCoverage
, 0
, { "both non-empty"
  , "low-priority empty"
  , "high-priority empty"
...
#ifndef _COV_STRUCT_PriorityListsCoverage
#define _COV_STRUCT_PriorityListsCoverage

struct _cov_struct_PriorityListsCoverage
{
    CoverageDesc* desc;
};
...
struct _cov_struct_PriorityListsCoverage PriorityListsCoverage = 
{ &_cov_desc_PriorityListsCoverage
};
...
CoverageElement _cov_calc_PriorityListsCoverage( void )
{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        if( size_List(r(high)) != 0 )
        {
            if( size_List(r(low)) != 0 )
            {
                { __res = (0); goto __destroy_body; }
            }
            else
        ...
        else
        {
            if( size_List(r(low)) != 0 )
            {
                { __res = (2); goto __destroy_body; }
            }
            else
            {
                { __res = (3); goto __destroy_body; }
            }
        }
...
static SubTypeDesc __type_desc__Item;

static SpecTypeDesc __type_desc__ref_Queue;
extern SpecificationID enq_spec;
...
static StructTypeDesc __type_desc__struct_PAR_RES_TYPE_enq_spec;

static void init_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *obj, va_list* arg_list )
{
    {
        Item __tmp;
        __tmp = va_arg( *arg_list, Item );
        ts_copy_sectype( (SECTypeDesc*)&__type_desc__Item
                       , &obj->inpar1
                       , &__tmp
                       , 1
                       );
...
static void copy_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *src, struct PAR_RES_TYPE_enq_spec *dst )
{
    ts_copy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enq_spec
                   , dst
                   , src
                   , 1
                   );
...
static int compare_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *left, struct PAR_RES_TYPE_enq_spec *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enq_spec, left, right ) )
      return 0;
    return 1;
}

static String* to_string_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enq_spec, obj );
}

static String* to_XML_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enq_spec, obj );
}

static void destroy_PAR_RES_TYPE_enq_spec( struct PAR_RES_TYPE_enq_spec *obj )
{
    ts_destroy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enq_spec, obj, 1 );
}

const Type type_PAR_RES_TYPE_enq_spec =
{
  "PAR_RES_TYPE_enq_spec",
  sizeof(struct PAR_RES_TYPE_enq_spec),
  &type_Object,
  (Init)init_PAR_RES_TYPE_enq_spec,
  (Copy)copy_PAR_RES_TYPE_enq_spec,
  (Compare)compare_PAR_RES_TYPE_enq_spec,
  (ToString)to_string_PAR_RES_TYPE_enq_spec,
  (ToXML)to_XML_PAR_RES_TYPE_enq_spec,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_PAR_RES_TYPE_enq_spec
};
...
CONTEXT_TYPE_enq_spec __context_enq_spec;
...
static MEDIATOR_enq_spec __mediator_enq_spec;

MEDIATOR_enq_spec set_mediator_enq_spec( MEDIATOR_enq_spec m )
{
  MEDIATOR_enq_spec old_m = __mediator_enq_spec;
  __mediator_enq_spec = m;
  return old_m;
}
...
bool pre_enq_spec( Item item )
{
    ...
    if( pre )
    {
        pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__Item
                                        , &item
                                        );
    }
    if (pre)
    {
        bool __alias1_has_value = 
                 1;
        bool __alias2_has_value = 
                 1;
        bool __alias3_has_value = 
                 1;
        _dummy( &__alias1_has_value );
        _dummy( &__alias2_has_value );
        _dummy( &__alias3_has_value );
        if (pre && __alias2_has_value)
        {
            pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__ref_Queue
                                            , &high
                                            );
        }
        if (pre && __alias3_has_value)
        {
            pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__ref_Queue
                                            , &low
                                            );
...
static bool __pre_enq_spec( PAR_RES_TYPE_enq_spec* params )
{
    bool res = pre_enq_spec(
              params->inpar1
    );
    destroy(params);
    return res;
...
CoverageElement _local_cov_calc_enq_spec( unsigned int _cov_num, Item item );


CoverageElement _cov_calc_enq_spec_c1( Item item );

CoverageDesc _cov_desc_enq_spec_c1 =
...
, -1
, "c1"
, &_cov_calc_enq_spec_c1
, 0
, { &_cov_desc_PriorityListsCoverage
  }
};

#ifndef _COV_STRUCT_enq_spec_c1
#define _COV_STRUCT_enq_spec_c1

struct _cov_struct_enq_spec_c1
{
    CoverageDesc* desc;
};
...
struct _cov_struct_enq_spec_c1 enq_spec_c1 = 
{ &_cov_desc_enq_spec_c1
};

CoverageElement _cov_calc_enq_spec_c1( Item item )
{
    CoverageElement __res = _local_cov_calc_enq_spec( 0 ,  item
         );
    return __res;
}
...
CoverageElement _local_cov_calc_enq_spec( unsigned int _cov_num, Item item )
{
    ...
    assertion( _cov_num < 1
             , "_local_cov_calc_enq_spec: illegal _cov_num"
             );
    if( pre )
    {
        pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__Item
    ...
    if( pre )
    {
        ...
        if( pre )
        {
            ...
            __after_pre:
                ...
                if ( pre )
                {
                    // calculation of coverage 'c1'
                    _cov_values[ 0 /* c1 */ ] = _CE_OUT_OF_COVERAGE;
                    _cov_values[ 0 /* c1 */ ] = 
                        ce_product( &_cov_desc_enq_spec_c1
                                  , _cov_calc_PriorityListsCoverage()
                                  );
...
void trace_info_enq_spec(void)
{
    traceCoverageStructureStart( "" );
    traceCoverageStructure( enq_spec_c1.desc );
    traceFormulaeStart();
    traceFormula( 0, "invariant type Item (@item)" );
    traceFormula( 1, "reads item" );
    traceFormula( 2, "invariant type Queue *(@high)" );
    traceFormula( 3, "reads high" );
    traceFormula( 4, "invariant type Queue *(@low)" );
    traceFormula( 5, "invariant type Queue *(low)" );
    traceFormulaeEnd();
    traceCoverageStructureEnd();
}

void trace_oracle_start_enq_spec(InteractionId refId)
{
    static int last_trace_id = -1;

    traceOracleStart( enq_spec->subsystem, enq_spec->signature, refId );
...
{
    bool pre = 1;
    CoverageElement _cov_val_enq_spec_c1 = _CE_OUT_OF_COVERAGE;
    CallProperties __properties;

    assertion( __media != (void*)0,  "Mediator of enq_spec is not set up");
    assertion( __oracle_properties != (void*)0, "Oracle properties cannot be NULL");

    __oracle_properties->verdict = 1;
    trace_oracle_start_enq_spec( __oracle_properties->refId );
    ...
    if( pre )
    {
        ...
        if (!pre) traceSystemInfo( "Invariant of item failed" );
    }
    assertion(pre, PRECONDITION_FAILED_MESSAGE);
    {
        ...
        if (pre && __alias2_has_value)
        {
            ...
            tracePrimeFormula( 2, pre );
            if (!pre) traceSystemInfo( "Invariant of high failed" );
        }
        if (pre && __alias3_has_value)
        {
            pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__ref_Queue
            ...
            tracePrimeFormula( 4, pre );
            if (!pre) traceSystemInfo( "Invariant of low failed" );
        }
        assertion(pre, PRECONDITION_FAILED_MESSAGE);
        {
            int __up = 0, __cmd = -3;
            ...
            __after_pre:
                ...
                // calculation of coverage 'c1'
                _cov_val_enq_spec_c1 = 
                    ce_product( &_cov_desc_enq_spec_c1
                              , _cov_calc_PriorityListsCoverage()
                              );

                traceReachedCoverageElement( enq_spec_c1.desc, _cov_val_enq_spec_c1 );

                __pre_expr_0_has_value = 
                         1;
                ts_start_copy_sectype();
                if (__alias1_has_value)
                  ts_copy_sectype( (SECTypeDesc*)&__type_desc__Item
                                 , &pre____alias1
                                 , &item
                                 , 0
                                 );
                if (__alias2_has_value)
                  ts_copy_sectype( (SECTypeDesc*)&__type_desc__ref_Queue
                                 , &pre____alias2
                                 , &high
                                 , 0
                                 );
                ...
                if (__oracle_properties->verdict && __alias1_has_value)
                {
                    __oracle_properties->verdict = 1;
                    if (!__oracle_properties->verdict)
                    {
                        ts_trace_bad_oracle_verdict();
                        traceSystemInfo("item is erroneous in post state");
                    }
                    else
                    {
                        __oracle_properties->verdict = ts_equals_sectype( (SECTypeDesc*)&__type_desc__Item,
                                                          &pre____alias1,
                                                          &item
                                                        );
                        tracePrimeFormula( 1, __oracle_properties->verdict );
                        if (!__oracle_properties->verdict)
                        {
                            ts_trace_bad_oracle_verdict();
                            traceSystemInfo("Reads object item has been changed");
                        }
                    }
                }
                if (__oracle_properties->verdict && __alias2_has_value)
                {
                    __oracle_properties->verdict = 1;
                    if (!__oracle_properties->verdict)
                    {
                        ts_trace_bad_oracle_verdict();
                        traceSystemInfo("high is erroneous in post state");
                    }
                    else
                    {
                        __oracle_properties->verdict = ts_equals_sectype( (SECTypeDesc*)&__type_desc__ref_Queue,
                                                          &pre____alias2,
                                                          &high
                                                        );
                        tracePrimeFormula( 3, __oracle_properties->verdict );
                        if (!__oracle_properties->verdict)
                        {
                            ts_trace_bad_oracle_verdict();
                            traceSystemInfo("Reads object high has been changed");
                        }
                    }
                }
                if( getCheckPostcondition() && __oracle_properties->verdict )
                {
                    {
                        {
                           __oracle_properties->verdict = ((compare(r((assertion( __pre_expr_0_has_value, "Incorrect value of '@low'" ), __pre_expr_0))
                        , subList_List(r(low)
                        , 0
                        , size_List(r(low)) - 1)) == 0) && (value_VoidAst(ts_check_spec_ref( &type_VoidAst, get_List(r(low)
                        , size_List(r(low)) - 1), "1 argument of value_VoidAst", "pqueue_model.sec(85,29)" )) == item));
                           goto __after_post;
                        }
        ...
        if( __alias1_has_value )
        {
            ts_destroy_sectype( (SECTypeDesc*)&__type_desc__Item
                              , &pre____alias1
                              , 0
                              );
        }
        if( __alias2_has_value )
        {
            ts_destroy_sectype( (SECTypeDesc*)&__type_desc__ref_Queue
                              , &pre____alias2
                              , 0
                              );
        }
...
OracleVerdict call_pure_oracle_enq_spec( CONTEXT_TYPE_enq_spec context )
{
    ...
    if ( getCheckPrecondition() && !pre_enq_spec(
              context.params->inpar1
                     )
       )
    {
        destroy(context.params);
        trace_oracle_start_enq_spec( context.refId );
        traceException( PRECONDITION_FAILED_MESSAGE );
        traceOracleEnd();
        return OracleVerdict_PreconditionFailed;
    }
    __context_enq_spec = context;
    __oracle_properties.refId = __context_enq_spec.refId;

    oracle_enq_spec(
              __mediator_enq_spec.parallel_mediator
             ,&__oracle_properties
             ,  context.params->inpar1
                   );
    destroy( __context_enq_spec.params );
    __context_enq_spec.params = (void*)0;
...
void call_active_oracle_enq_spec( Item item )
{
    CallProperties __properties;
    String* tmp_;
    assertion( __mediator_enq_spec.sequential_mediator != (void*)0, "Mediator of enq_spec is not set up" );
    traceModelOperationStart( "stimulus", enq_spec->subsystem, enq_spec->signature );
    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc__Item
                              , &item
                              );
    traceModelOperationArgument( "Item"
                               , "@item"
    ...
    switch (getTSMode())
    {
        case SequentialTSMode:
            {
                ...
                oracle_enq_spec(
                           __mediator_enq_spec.sequential_mediator
                          ,&__oracle_properties
                         ,  item
                               );
        ...
        case ParallelTSMode:
        {
            PAR_RES_TYPE_enq_spec* __context;
            Item inpar1;
            ...
            __mediator_enq_spec.call_mediator(
                      &__properties
                     ,  item
                                             );
            __context = create( &type_PAR_RES_TYPE_enq_spec
                     ,  inpar1
                     ,  item
                 );
            registerStimulus( "enq_spec", enq_spec, __context, __properties.time );
...
void trace_model_operation_enq_spec( InteractionId refId, PAR_RES_TYPE_enq_spec* params, ChannelID chid, TimeInterval timestamp )
{
    String* tmp_;
    traceModelOperationStart( "stimulus", enq_spec->subsystem, enq_spec->signature );
    traceModelOperationIdentifier(refId);
    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc__Item, &params->inpar1 );
    traceModelOperationArgument( "Item"
                               , "@item"
                               , toCharArray_String(r(tmp_))
                               );
    ...
    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc__Item, &params->outpar1 );
    traceModelOperationArgument( "Item"
                               , "item"
                               , toCharArray_String(r(tmp_))
                               );
...
SpecificationDesc desc_enq_spec =
{
    "enq_spec",
    "",
    "void enq_spec( Item item )",
    (PreFuncType)__pre_enq_spec,
    (CallPureOracleFuncType)call_pure_oracle_enq_spec,
    (TraceModelOperationFuncType)trace_model_operation_enq_spec,
    0,
    &type_PAR_RES_TYPE_enq_spec
};

SpecificationID enq_spec = &desc_enq_spec;
...
static StructTypeDesc __type_desc__struct_PAR_RES_TYPE_enqp_spec;

static void init_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *obj, va_list* arg_list )
{
    {
        Item __tmp;
        __tmp = va_arg( *arg_list, Item );
...
static void copy_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *src, struct PAR_RES_TYPE_enqp_spec *dst )
{
    ts_copy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enqp_spec
                   , dst
                   , src
                   , 1
                   );
...
static int compare_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *left, struct PAR_RES_TYPE_enqp_spec *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enqp_spec, left, right ) )
      return 0;
    return 1;
}

static String* to_string_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enqp_spec, obj );
}

static String* to_XML_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enqp_spec, obj );
}

static void destroy_PAR_RES_TYPE_enqp_spec( struct PAR_RES_TYPE_enqp_spec *obj )
{
    ts_destroy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_enqp_spec, obj, 1 );
}

const Type type_PAR_RES_TYPE_enqp_spec =
{
  "PAR_RES_TYPE_enqp_spec",
  sizeof(struct PAR_RES_TYPE_enqp_spec),
  &type_Object,
  (Init)init_PAR_RES_TYPE_enqp_spec,
  (Copy)copy_PAR_RES_TYPE_enqp_spec,
  (Compare)compare_PAR_RES_TYPE_enqp_spec,
  (ToString)to_string_PAR_RES_TYPE_enqp_spec,
  (ToXML)to_XML_PAR_RES_TYPE_enqp_spec,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_PAR_RES_TYPE_enqp_spec
};
...
CONTEXT_TYPE_enqp_spec __context_enqp_spec;
...
static MEDIATOR_enqp_spec __mediator_enqp_spec;

MEDIATOR_enqp_spec set_mediator_enqp_spec( MEDIATOR_enqp_spec m )
{
  MEDIATOR_enqp_spec old_m = __mediator_enqp_spec;
  __mediator_enqp_spec = m;
  return old_m;
}
...
static bool __pre_enqp_spec( PAR_RES_TYPE_enqp_spec* params )
{
    bool res = pre_enqp_spec(
              params->inpar1
    );
    destroy(params);
    return res;
...
CoverageElement _local_cov_calc_enqp_spec( unsigned int _cov_num, Item item );


CoverageElement _cov_calc_enqp_spec_c1( Item item );

CoverageDesc _cov_desc_enqp_spec_c1 =
{ DOMAIN_VARIATION_COVERAGE
, 4
, 1
, 1
...
, -1
, "c1"
, &_cov_calc_enqp_spec_c1
, 0
, { &_cov_desc_PriorityListsCoverage
  }
};

#ifndef _COV_STRUCT_enqp_spec_c1
#define _COV_STRUCT_enqp_spec_c1

struct _cov_struct_enqp_spec_c1
{
    CoverageDesc* desc;
};
...
struct _cov_struct_enqp_spec_c1 enqp_spec_c1 = 
{ &_cov_desc_enqp_spec_c1
};

CoverageElement _cov_calc_enqp_spec_c1( Item item )
{
    CoverageElement __res = _local_cov_calc_enqp_spec( 0 ,  item
         );
    return __res;
}
...
CoverageElement _local_cov_calc_enqp_spec( unsigned int _cov_num, Item item )
{
    ...
    int _cov_values[ 1 ];
    assertion( _cov_num < 1
             , "_local_cov_calc_enqp_spec: illegal _cov_num"
             );
    if( pre )
    {
        pre = ts_check_invariant_sectype( (SECTypeDesc*)&__type_desc__Item
        ...
        if( pre )
        {
            ...
            __after_pre:
                ...
                if ( pre )
                {
                    ...
                    _cov_values[ 0 /* c1 */ ] = _CE_OUT_OF_COVERAGE;
                    _cov_values[ 0 /* c1 */ ] = 
                        ce_product( &_cov_desc_enqp_spec_c1
                                  , _cov_calc_PriorityListsCoverage()
                                  );
...
void trace_info_enqp_spec(void)
{
    traceCoverageStructureStart( "" );
    traceCoverageStructure( enqp_spec_c1.desc );
    traceFormulaeStart();
    traceFormula( 0, "invariant type Item (@item)" );
    traceFormula( 1, "reads item" );
    traceFormula( 2, "invariant type Queue *(@high)" );
    traceFormula( 3, "invariant type Queue *(high)" );
    traceFormula( 4, "invariant type Queue *(@low)" );
    traceFormula( 5, "reads low" );
    traceFormulaeEnd();
    traceCoverageStructureEnd();
}

void trace_oracle_start_enqp_spec(InteractionId refId)
{
    static int last_trace_id = -1;

    traceOracleStart( enqp_spec->subsystem, enqp_spec->signature, refId );

    if( last_trace_id < getTraceId() )
    {
        last_trace_id = getTraceId();
        trace_info_enqp_spec();
    }
}
...
{
    bool pre = 1;
    CoverageElement _cov_val_enqp_spec_c1 = _CE_OUT_OF_COVERAGE;
    CallProperties __properties;

    assertion( __media != (void*)0,  "Mediator of enqp_spec is not set up");
    assertion( __oracle_properties != (void*)0, "Oracle properties cannot be NULL");

    __oracle_properties->verdict = 1;
    trace_oracle_start_enqp_spec( __oracle_properties->refId );
    ...
    assertion(pre, PRECONDITION_FAILED_MESSAGE);
    {
        ...
        assertion(pre, PRECONDITION_FAILED_MESSAGE);
        {
            ...
            __after_pre:
                ...
                // calculation of coverage 'c1'
                _cov_val_enqp_spec_c1 = 
                    ce_product( &_cov_desc_enqp_spec_c1
                              , _cov_calc_PriorityListsCoverage()
                              );

                traceReachedCoverageElement( enqp_spec_c1.desc, _cov_val_enqp_spec_c1 );
                ...
                if (__oracle_properties->verdict && __alias3_has_value)
                {
                    __oracle_properties->verdict = 1;
                    if (!__oracle_properties->verdict)
                    {
                        ts_trace_bad_oracle_verdict();
                        traceSystemInfo("low is erroneous in post state");
                    }
                    else
                    {
                        __oracle_properties->verdict = ts_equals_sectype( (SECTypeDesc*)&__type_desc__ref_Queue,
                        ...
                        tracePrimeFormula( 5, __oracle_properties->verdict );
                        if (!__oracle_properties->verdict)
                        {
                            ts_trace_bad_oracle_verdict();
                            traceSystemInfo("Reads object low has been changed");
                        }
                    }
                }
                if( getCheckPostcondition() && __oracle_properties->verdict )
                {
                    {
                        {
                           __oracle_properties->verdict = ((compare(r((assertion( __pre_expr_0_has_value, "Incorrect value of '@high'" ), __pre_expr_0))
                        , subList_List(r(high)
                        , 0
                        , size_List(r(high)) - 1)) == 0) && (value_VoidAst(ts_check_spec_ref( &type_VoidAst, get_List(r(high)
                        , size_List(r(high)) - 1), "1 argument of value_VoidAst", "pqueue_model.sec(107,29)" )) == item));
                           goto __after_post;
                        }
...
{
    OracleCallProperties __oracle_properties;
    if ( getCheckPrecondition() && !pre_enqp_spec(
              context.params->inpar1
                     )
       )
    {
        destroy(context.params);
        trace_oracle_start_enqp_spec( context.refId );
        traceException( PRECONDITION_FAILED_MESSAGE );
        traceOracleEnd();
        return OracleVerdict_PreconditionFailed;
    }
    __context_enqp_spec = context;
    __oracle_properties.refId = __context_enqp_spec.refId;

    oracle_enqp_spec(
              __mediator_enqp_spec.parallel_mediator
             ,&__oracle_properties
             ,  context.params->inpar1
                   );
    destroy( __context_enqp_spec.params );
    __context_enqp_spec.params = (void*)0;
    return __oracle_properties.verdict ? OracleVerdict_Ok : OracleVerdict_PostconditionFailed;
}
...
void call_active_oracle_enqp_spec( Item item )
{
    CallProperties __properties;
    String* tmp_;
    assertion( __mediator_enqp_spec.sequential_mediator != (void*)0, "Mediator of enqp_spec is not set up" );
    traceModelOperationStart( "stimulus", enqp_spec->subsystem, enqp_spec->signature );
    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc__Item
                              , &item
                              );
    traceModelOperationArgument( "Item"
    ...
    switch (getTSMode())
    {
        case SequentialTSMode:
            {
                ...
                __oracle_properties.refId = -1;
                oracle_enqp_spec(
                           __mediator_enqp_spec.sequential_mediator
                          ,&__oracle_properties
                         ,  item
                               );
                setOracleVerdict( __oracle_properties.verdict );
        ...
        case ParallelTSMode:
        {
            PAR_RES_TYPE_enqp_spec* __context;
            Item inpar1;
            ...
            __mediator_enqp_spec.call_mediator(
                      &__properties
                     ,  item
                                             );
            __context = create( &type_PAR_RES_TYPE_enqp_spec
                     ,  inpar1
                     ,  item
                 );
            registerStimulus( "enqp_spec", enqp_spec, __context, __properties.time );
...
void trace_model_operation_enqp_spec( InteractionId refId, PAR_RES_TYPE_enqp_spec* params, ChannelID chid, TimeInterval timestamp )
{
    String* tmp_;
    traceModelOperationStart( "stimulus", enqp_spec->subsystem, enqp_spec->signature );
    traceModelOperationIdentifier(refId);
...
SpecificationDesc desc_enqp_spec =
{
    "enqp_spec",
    "",
    "void enqp_spec( Item item )",
    (PreFuncType)__pre_enqp_spec,
    (CallPureOracleFuncType)call_pure_oracle_enqp_spec,
    (TraceModelOperationFuncType)trace_model_operation_enqp_spec,
    0,
    &type_PAR_RES_TYPE_enqp_spec
};

SpecificationID enqp_spec = &desc_enqp_spec;

static SimpleTypeDesc __type_desc___void_ptr;
...
static StructTypeDesc __type_desc__struct_PAR_RES_TYPE_deq_spec;

static void init_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *obj, va_list* arg_list )
{
    {
        void *__tmp;
        __tmp = va_arg( *arg_list, void * );
        ts_copy_sectype( (SECTypeDesc*)&__type_desc___void_ptr
                       , &obj->res
                       , &__tmp
                       , 1
                       );
...
static void copy_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *src, struct PAR_RES_TYPE_deq_spec *dst )
{
    ts_copy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_deq_spec
                   , dst
                   , src
                   , 1
                   );
...
static int compare_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *left, struct PAR_RES_TYPE_deq_spec *right )
{
    if( ts_equals_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_deq_spec, left, right ) )
      return 0;
    return 1;
}

static String* to_string_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *obj )
{
    return ts_to_string_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_deq_spec, obj );
}

static String* to_XML_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *obj )
{
    return ts_to_XML_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_deq_spec, obj );
}

static void destroy_PAR_RES_TYPE_deq_spec( struct PAR_RES_TYPE_deq_spec *obj )
{
    ts_destroy_sectype( (SECTypeDesc*)&__type_desc__struct_PAR_RES_TYPE_deq_spec, obj, 1 );
}

const Type type_PAR_RES_TYPE_deq_spec =
{
  "PAR_RES_TYPE_deq_spec",
  sizeof(struct PAR_RES_TYPE_deq_spec),
  &type_Object,
  (Init)init_PAR_RES_TYPE_deq_spec,
  (Copy)copy_PAR_RES_TYPE_deq_spec,
  (Compare)compare_PAR_RES_TYPE_deq_spec,
  (ToString)to_string_PAR_RES_TYPE_deq_spec,
  (ToXML)to_XML_PAR_RES_TYPE_deq_spec,
  (CheckInvariant)check_invariant_Default,
  (Enumerate)enumerate_Default,
  (Destroy)destroy_PAR_RES_TYPE_deq_spec
};
...
CONTEXT_TYPE_deq_spec __context_deq_spec;
...
static MEDIATOR_deq_spec __mediator_deq_spec;

MEDIATOR_deq_spec set_mediator_deq_spec( MEDIATOR_deq_spec m )
{
  MEDIATOR_deq_spec old_m = __mediator_deq_spec;
  __mediator_deq_spec = m;
  return old_m;
}
...
static bool __pre_deq_spec( PAR_RES_TYPE_deq_spec* params )
{
    bool res = pre_deq_spec(
    );
    destroy(params);
    return res;
}

CoverageElement _local_cov_calc_deq_spec( unsigned int _cov_num );


CoverageElement _cov_calc_deq_spec_c1( void );

CoverageDesc _cov_desc_deq_spec_c1 =
{ DOMAIN_VARIATION_COVERAGE
, 4
, 1
, 1
...
, -1
, "c1"
, &_cov_calc_deq_spec_c1
, 0
, { &_cov_desc_PriorityListsCoverage
  }
};

#ifndef _COV_STRUCT_deq_spec_c1
#define _COV_STRUCT_deq_spec_c1

struct _cov_struct_deq_spec_c1
{
    CoverageDesc* desc;
};
...
struct _cov_struct_deq_spec_c1 deq_spec_c1 = 
{ &_cov_desc_deq_spec_c1
};

CoverageElement _cov_calc_deq_spec_c1( void )
{
    CoverageElement __res = _local_cov_calc_deq_spec( 0 );
    return __res;
}
...
CoverageElement _local_cov_calc_deq_spec( unsigned int _cov_num )
{
    ...
    int _cov_values[ 1 ];
    assertion( _cov_num < 1
             , "_local_cov_calc_deq_spec: illegal _cov_num"
             );
    if( pre )
    {
        bool __alias1_has_value = 
        ...
        if( pre )
        {
            ...
            __after_pre:
                ...
                if ( pre )
                {
                    ...
                    _cov_values[ 0 /* c1 */ ] = _CE_OUT_OF_COVERAGE;
                    _cov_values[ 0 /* c1 */ ] = 
                        ce_product( &_cov_desc_deq_spec_c1
                                  , _cov_calc_PriorityListsCoverage()
                                  );
...
void trace_info_deq_spec(void)
{
    traceCoverageStructureStart( "" );
    traceCoverageStructure( deq_spec_c1.desc );
    traceFormulaeStart();
    traceFormula( 0, "invariant type Queue *(@high)" );
    traceFormula( 1, "invariant type Queue *(high)" );
    traceFormula( 2, "invariant type Queue *(@low)" );
    traceFormula( 3, "invariant type Queue *(low)" );
    traceFormulaeEnd();
    traceCoverageStructureEnd();
}

void trace_oracle_start_deq_spec(InteractionId refId)
{
    static int last_trace_id = -1;

    traceOracleStart( deq_spec->subsystem, deq_spec->signature, refId );
...
{
    bool pre = 1;
    CoverageElement _cov_val_deq_spec_c1 = _CE_OUT_OF_COVERAGE;
    CallProperties __properties;
    void *__res;

    assertion( __media != (void*)0,  "Mediator of deq_spec is not set up");
    assertion( __oracle_properties != (void*)0, "Oracle properties cannot be NULL");

    __oracle_properties->verdict = 1;
    trace_oracle_start_deq_spec( __oracle_properties->refId );
    ...
    assertion(pre, PRECONDITION_FAILED_MESSAGE);
    {
        ...
        Queue *__pre_expr_4;
        bool __pre_expr_5_has_value = 0;
        Queue *__pre_expr_5;
        bool __pre_expr_6_has_value = 0;
        Queue *__pre_expr_6;
        bool __pre_expr_7_has_value = 0;
        Queue *__pre_expr_7;
        bool __pre_expr_8_has_value = 0;
        Queue *__pre_expr_8;
        bool __pre_expr_9_has_value = 0;
        Queue *__pre_expr_9;
        bool __pre_expr_10_has_value = 0;
        Queue *__pre_expr_10;
        bool __pre_expr_11_has_value = 0;
        Queue *__pre_expr_11;
        _dummy( &__alias1_has_value );
        _dummy( &__alias2_has_value );
        if (pre && __alias1_has_value)
        ...
        assertion(pre, PRECONDITION_FAILED_MESSAGE);
        {
            ...
            __after_pre:
                ...
                // calculation of coverage 'c1'
                _cov_val_deq_spec_c1 = 
                    ce_product( &_cov_desc_deq_spec_c1
                              , _cov_calc_PriorityListsCoverage()
                              );

                traceReachedCoverageElement( deq_spec_c1.desc, _cov_val_deq_spec_c1 );
                ...
                __pre_expr_4_has_value = 
                         1;
                __pre_expr_5_has_value = 
                         1;
                __pre_expr_6_has_value = 
                         1;
                __pre_expr_7_has_value = 
                         1;
                __pre_expr_8_has_value = 
                         1;
                __pre_expr_9_has_value = 
                         1;
                __pre_expr_10_has_value = 
                         1;
                __pre_expr_11_has_value = 
                         1;
                ts_start_copy_sectype();
                if (__pre_expr_0_has_value)
                {
                ...
                {
                    {
                        if( size_List(r((assertion( __pre_expr_0_has_value, "Incorrect value of '@high'" ), __pre_expr_0))) != 0 )
                        {
                            {
                               __oracle_properties->verdict = ((compare(subList_List(r((assertion( __pre_expr_1_has_value, "Incorrect value of '@high'" ), __pre_expr_1))
                            , 1
                            , size_List(r((assertion( __pre_expr_2_has_value, "Incorrect value of '@high'" ), __pre_expr_2))))
                            , r(high)) == 0) && (compare(r((assertion( __pre_expr_3_has_value, "Incorrect value of '@low'" ), __pre_expr_3))
                            , r(low)) == 0) && (__res == value_VoidAst(ts_check_spec_ref( &type_VoidAst, get_List(r((assertion( __pre_expr_4_has_value, "Incorrect value of '@high'" ), __pre_expr_4))
                            , 0), "1 argument of value_VoidAst", "pqueue_model.sec(138,43)" ))));
                               goto __after_post;
                            }
                        }
                        else
                        {
                            if( size_List(r((assertion( __pre_expr_5_has_value, "Incorrect value of '@low'" ), __pre_expr_5))) != 0 )
                            {
                                {
                                   __oracle_properties->verdict = ((compare(subList_List(r((assertion( __pre_expr_6_has_value, "Incorrect value of '@low'" ), __pre_expr_6))
                                , 1
                                , size_List(r((assertion( __pre_expr_7_has_value, "Incorrect value of '@low'" ), __pre_expr_7))))
                                , r(low)) == 0) && (compare(r((assertion( __pre_expr_8_has_value, "Incorrect value of '@high'" ), __pre_expr_8))
                                , r(high)) == 0) && (__res == value_VoidAst(ts_check_spec_ref( &type_VoidAst, get_List(r((assertion( __pre_expr_9_has_value, "Incorrect value of '@low'" ), __pre_expr_9))
                                , 0), "1 argument of value_VoidAst", "pqueue_model.sec(142,43)" ))));
                                   goto __after_post;
                                }
                            }
                            else
                            {
                                {
                                   __oracle_properties->verdict = ((compare(r((assertion( __pre_expr_10_has_value, "Incorrect value of '@low'" ), __pre_expr_10))
                                , r(low)) == 0) && (compare(r((assertion( __pre_expr_11_has_value, "Incorrect value of '@high'" ), __pre_expr_11))
                                , r(high)) == 0) && (__res == ((void *)0)));
                                   goto __after_post;
                                }
                            }
                        }
...
OracleVerdict call_pure_oracle_deq_spec( CONTEXT_TYPE_deq_spec context )
{
    OracleCallProperties __oracle_properties;
    void *__res;
    if ( getCheckPrecondition() && !pre_deq_spec(
                     )
       )
    {
        destroy(context.params);
        trace_oracle_start_deq_spec( context.refId );
        traceException( PRECONDITION_FAILED_MESSAGE );
        traceOracleEnd();
        return OracleVerdict_PreconditionFailed;
    }
    __context_deq_spec = context;
    __oracle_properties.refId = __context_deq_spec.refId;

    __res = oracle_deq_spec(
              __mediator_deq_spec.parallel_mediator
             ,&__oracle_properties
                   );
    destroy( __context_deq_spec.params );
    __context_deq_spec.params = (void*)0;
    return __oracle_properties.verdict ? OracleVerdict_Ok : OracleVerdict_PostconditionFailed;
}
...
void *call_active_oracle_deq_spec( void )
{
    ...
    void *__res;
    String* tmp_;
    assertion( __mediator_deq_spec.sequential_mediator != (void*)0, "Mediator of deq_spec is not set up" );
    traceModelOperationStart( "stimulus", deq_spec->subsystem, deq_spec->signature );
    ...
    switch (getTSMode())
    {
        case SequentialTSMode:
            {
                ...
                __oracle_properties.refId = -1;
                __res = oracle_deq_spec(
                           __mediator_deq_spec.sequential_mediator
                          ,&__oracle_properties
                               );
                setOracleVerdict( __oracle_properties.verdict );
                break;
        ...
        case ParallelTSMode:
        {
            PAR_RES_TYPE_deq_spec* __context;


            __res = __mediator_deq_spec.call_mediator(
                      &__properties
                                             );
            __context = create( &type_PAR_RES_TYPE_deq_spec
                 , __res
                 );
            registerStimulus( "deq_spec", deq_spec, __context, __properties.time );
    ...
    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc___void_ptr, &__res );
    traceModelOperationResult( "void *"
                             , toCharArray_String(r(tmp_))
                             );
    destroy(tmp_);
    if( getTSMode() == ParallelTSMode )
...
void trace_model_operation_deq_spec( InteractionId refId, PAR_RES_TYPE_deq_spec* params, ChannelID chid, TimeInterval timestamp )
{
    String* tmp_;
    traceModelOperationStart( "stimulus", deq_spec->subsystem, deq_spec->signature );
    traceModelOperationIdentifier(refId);

    tmp_ = ts_to_trace_sectype( (SECTypeDesc*)&__type_desc___void_ptr, &params->res );
    traceModelOperationResult( "void *"
                             , toCharArray_String(r(tmp_))
                             );
    destroy(tmp_);
...
SpecificationDesc desc_deq_spec =
{
    "deq_spec",
    "",
    "void *deq_spec( void )",
    (PreFuncType)__pre_deq_spec,
    (CallPureOracleFuncType)call_pure_oracle_deq_spec,
    (TraceModelOperationFuncType)trace_model_operation_deq_spec,
    0,
    &type_PAR_RES_TYPE_deq_spec
};

SpecificationID deq_spec = &desc_deq_spec;
...
, ((void*)0)
, "Item"
, (SECTypeDesc*)&__type_desc___void_ptr
, (InvariantCheckerPtr)invariant_type_Item
};
...
static FieldDesc __fields_desc__struct_PAR_RES_TYPE_enq_spec[] = 
{
    { "inpar1", ((char*)(&((struct PAR_RES_TYPE_enq_spec*)0)->inpar1) - (char*)0), (SECTypeDesc*)&__type_desc__Item },
    { "outpar1", ((char*)(&((struct PAR_RES_TYPE_enq_spec*)0)->outpar1) - (char*)0), (SECTypeDesc*)&__type_desc__Item }
};
...
, sizeof( struct PAR_RES_TYPE_enq_spec )
, 2
, __fields_desc__struct_PAR_RES_TYPE_enq_spec
};
...
static FieldDesc __fields_desc__struct_PAR_RES_TYPE_enqp_spec[] = 
{
    { "inpar1", ((char*)(&((struct PAR_RES_TYPE_enqp_spec*)0)->inpar1) - (char*)0), (SECTypeDesc*)&__type_desc__Item },
    { "outpar1", ((char*)(&((struct PAR_RES_TYPE_enqp_spec*)0)->outpar1) - (char*)0), (SECTypeDesc*)&__type_desc__Item }
};
...
, sizeof( struct PAR_RES_TYPE_enqp_spec )
, 2
, __fields_desc__struct_PAR_RES_TYPE_enqp_spec
};




static FieldDesc __fields_desc__struct_PAR_RES_TYPE_deq_spec[] = 
{
    { "res", ((char*)(&((struct PAR_RES_TYPE_deq_spec*)0)->res) - (char*)0), (SECTypeDesc*)&__type_desc___void_ptr }
};
...
, sizeof( struct PAR_RES_TYPE_deq_spec )
, 1
, __fields_desc__struct_PAR_RES_TYPE_deq_spec
};
