...
/**  Date: Fri May 17 15:38:21 CST 2024                                      **/
/**                                                                          **/
/******************************************************************************/
...

{
    ...
    _dummy( &__up ); _dummy( &__cmd );
    {
        ...
        for( k = impl_stack->size
           ; k > 0
           ; append_List(r(stck)
        , create_Integer(impl_stack->elems[ --k ]))
           )
        {
            ;
        }
...
bool sequential_push_media( CallProperties* __properties, int i )
{
    bool __res;
    ...
    clearBadVerdict();
    {
        ...
        __after_call:
            ...
            if (__properties->verdict && __alias1_has_value)
            {
                __properties->verdict = invariant_var_stck();
                tracePrimeFormula( 1, __properties->verdict );
                  if (!__properties->verdict) setBadVerdict( "Invariant of stck failed" );
            }
...
bool call_push_media( CallProperties* __properties, int i )
{
    bool __res;
    bool __alias1_has_value = 
             1;
...
bool parallel_push_media( CallProperties* __properties, int i )
{
    bool __alias1_has_value = 
             1;
    _dummy( &__alias1_has_value );
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_push_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
    ...
    return __context_push_spec.params->res;
}

MEDIATOR_push_spec push_media = 
{
  sequential_push_media,
  call_push_media,
  parallel_push_media
};
...
bool sequential_pop_media( CallProperties* __properties, int *item )
{
    bool __res;
    bool __alias1_has_value = 
             1;
...
bool call_pop_media( CallProperties* __properties, int *item )
{
    bool __res;
    bool __alias1_has_value = 
             1;
...
bool parallel_pop_media( CallProperties* __properties, int *item )
{
    bool __alias1_has_value = 
             1;
    bool i_has_value = 
    ...
    assertion( __properties!=(void*)0, "__properties is NULL in mediator" );
    __properties->verdict = 1;
    __properties->time = __context_pop_spec.time;
    clearBadVerdict();
    {
        int __up = 0, __cmd = -3;
        _dummy( &__up ); _dummy( &__cmd );
        {
            assertion( (item == (void*)0) == (__context_pop_spec.params->outpar1 == (void*)0), 
                       "Inconsistent parameter value: item"
                     );
            if (item != (void*)0)
              ts_copy_sectype( (SECTypeDesc*)&__type_desc__int, item, __context_pop_spec.params->outpar1, 1 );
    ...
    return __context_pop_spec.params->res;
}

MEDIATOR_pop_spec pop_media = 
{
  sequential_pop_media,
  call_pop_media,
  parallel_pop_media
};
